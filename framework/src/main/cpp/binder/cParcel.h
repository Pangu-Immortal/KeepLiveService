/**
 * ============================================================================
 * cParcel.h - Parcel 数据容器头文件
 * ============================================================================
 *
 * 功能简介：
 *   定义 Android Binder IPC 机制中的 Parcel 类，用于进程间通信数据的
 *   序列化和反序列化。该类是 Binder 通信的核心数据载体。
 *
 * 主要类/接口：
 *   - Parcel：数据容器主类，提供读写各种数据类型的方法
 *   - Parcel::Blob：用于大数据块传输的内部类
 *   - Parcel::ReadableBlob/WritableBlob：只读/可写 Blob 封装
 *   - FlattenableHelperInterface：可扁平化对象接口
 *
